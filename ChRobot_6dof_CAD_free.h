...
#ifndef CH_ROBOT_6DOF_CAD_FREE_H
#define CH_ROBOT_6DOF_CAD_FREE_H
...
class ChRobot_6dof_CAD_free : public ChRobot_6dof_free {
//class CH_MODELS_API ChRobot_6dof_CAD : public ChRobot_6dof {
public:
    /// Default constructor.
    ChRobot_6dof_CAD_free() {};
    ...
    ChRobot_6dof_CAD_free(
        ...
        std::vector<std::string> bodynames = { "Base_UR5_STEP", "Link1_UR5_STEP", "Link2_UR5_STEP", "Link3_UR5_STEP",  "Link4_UR5_STEP_1000515", "Link5_UR5_STEP", "Link6_UR5_STEP" }                                                                                                                      ///  NB: if 'base' body is not provided here, robot arm is linked to internal 'ground' instead (fallback)
    );
...
#endif // end CH_ROBOT_6DOF_CAD_FREE_H
