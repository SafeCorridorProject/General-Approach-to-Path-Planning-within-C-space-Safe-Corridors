...
ChRobot_6dof_CAD_free::ChRobot_6dof_CAD_free(ChSystem* system, const ChCoordsys<>& base_coord, unsigned int id, std::vector<std::string> bodynames)
...
void ChRobot_6dof_CAD_free::SetupBodies() {  
...
void ChRobot_6dof_CAD_free::SetupMarkers() {
...
void ChRobot_6dof_CAD_free::SetupLinks() {
    m_motfunlist = {
