...
ChRobot_6dof_free::ChRobot_6dof_free(ChSystem* system, const std::array<double, 4>& lengths, const ChCoordsys<>& base_coord) {
    m_system = system;
...
void ChRobot_6dof_free::SetupBodies() {
    // Base
...
void ChRobot_6dof_free::SetupMarkers() {
...
void ChRobot_6dof_free::SetupLinks() {
    m_motfunlist = { 
    ...
    m_link_base_shoulder = chrono_types::make_shared<ChLinkMateRevolute>();
    ...
    m_link_shoulder_biceps = chrono_types::make_shared<ChLinkMateRevolute>();
    ...
    // Link biceps-elbow
    m_link_biceps_elbow = chrono_types::make_shared<ChLinkMateRevolute>();
    ...
    // Link elbow-forearm
    m_link_elbow_forearm = chrono_types::make_shared<ChLinkMateRevolute>();
    ...
    // Link forearm-wrist
    m_link_forearm_wrist = chrono_types::make_shared<ChLinkMateRevolute>();
    ...
    m_link_wrist_end_effector = chrono_types::make_shared<ChLinkMateRevolute>();
...
ChVectorDynamic<> ChRobot_6dof_free::GetMotorsRot() const {
    ChVectorDynamic<> angles(6);
    angles <<
        m_link_base_shoulder->GetRelativeAngle(),
        m_link_shoulder_biceps->GetRelativeAngle(),
        m_link_biceps_elbow->GetRelativeAngle(),
        m_link_elbow_forearm->GetRelativeAngle(),
        m_link_forearm_wrist->GetRelativeAngle(),
        m_link_wrist_end_effector->GetRelativeAngle();
    return angles;
}

ChVectorDynamic<> ChRobot_6dof_free::GetMotorsRot_dt() const {
    ChVectorDynamic<> vels(6);
    vels <<
        m_link_base_shoulder->GetRelativeAngleDt(),
        m_link_shoulder_biceps->GetRelativeAngleDt(),
        m_link_biceps_elbow->GetRelativeAngleDt(),
        m_link_elbow_forearm->GetRelativeAngleDt(),
        m_link_forearm_wrist->GetRelativeAngleDt(),
        m_link_wrist_end_effector->GetRelativeAngleDt();
    return vels;
}

ChVectorDynamic<> ChRobot_6dof_free::GetMotorsRot_dtdt() const {
    ChVectorDynamic<> accels(6);
    accels <<
        m_link_base_shoulder->GetRelativeAngleDt2(),
        m_link_shoulder_biceps->GetRelativeAngleDt2(),
        m_link_biceps_elbow->GetRelativeAngleDt2(),
        m_link_elbow_forearm->GetRelativeAngleDt2(),
        m_link_forearm_wrist->GetRelativeAngleDt2(),
        m_link_wrist_end_effector->GetRelativeAngleDt2();
    return accels;
}

//ChVectorDynamic<> ChRobot_6dof_free::GetMotorsTorque() const {
...
void ChRobot_6dof_free::Add1dShapes(const ChColor& col) {
    //// Link 1
...
void ChRobot_6dof_free::Add3dShapes(double rad, const ChColor& col) {
