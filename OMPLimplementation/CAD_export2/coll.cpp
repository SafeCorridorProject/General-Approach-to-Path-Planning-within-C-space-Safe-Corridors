...
std::string shapes_dir = "CAD_export_coll/coll_shapes/";
...
body_1->SetPos(chrono::ChVector3d(-0.913569625239967,0.779780587878785,0.833682131953119));
body_1->SetRot(chrono::ChQuaternion<>(0.770010345469714,0.0131535793983151,0.637698039659849,0.0158827400850448));
body_1->SetMass(10.3747911520124);
body_1->SetInertiaXX(chrono::ChVector3d(0.34588869954128,0.0224426175505801,0.349268449088684));
body_1->SetInertiaXY(chrono::ChVector3d(-0.0136048375589211,0.000553547521481235,1.93767265747214e-05));
body_1->SetFrameCOMToRef(chrono::ChFramed(chrono::ChVector3d(-7.99681834387573e-07,0.376650266285153,0.13953119224553),chrono::ChQuaternion<>(1,0,0,0)));
...
chrono::ChVector3d p1_body_1(2.3735914380224E-15,0.5875,0.2104);
chrono::ChVector3d p2_body_1(2.38977494309316E-15,0.5875,0.0744);
body_1->GetCollisionModel()->AddCylinder(mat_1,0.065,p1_body_1,p2_body_1);
chrono::ChVector3d p3_body_1(-2.8167836289516E-16,0.2091,0.1378);
chrono::ChVector3d p4_body_1(1.37236539871527E-16,0.5531,0.1378);
body_1->GetCollisionModel()->AddCylinder(mat_1,0.055,p3_body_1,p4_body_1);
chrono::ChVector3d p5_body_1(2.53911659356505E-15,0.1625,0.2114);
chrono::ChVector3d p6_body_1(2.51837380209101E-15,0.1625,0.0744);
body_1->GetCollisionModel()->AddCylinder(mat_1,0.0650000000000029,p5_body_1,p6_body_1);
...
body_2->SetName("Link4_UR5_STEP_1000515-1");
body_2->SetPos(chrono::ChVector3d(-0.825439633185542,1.68785595180735,0.369003787663318));
body_2->SetRot(chrono::ChQuaternion<>(0.366937595612014,0.56078970071398,0.303886027994261,0.677144736736151));
body_2->SetMass(1.63038930409274);
body_2->SetInertiaXX(chrono::ChVector3d(0.00258396413104162,0.00241155539459893,0.00258281431379276));
body_2->SetInertiaXY(chrono::ChVector3d(-0.00033478659628426,0.00014728996358411,-0.000159736895660383));
body_2->SetFrameCOMToRef(chrono::ChFramed(chrono::ChVector3d(0.335801640555169,0.39362114302927,0.118242292293933),chrono::ChQuaternion<>(1,0,0,0)));
...
collshape_2 = chrono_types::make_shared<chrono::ChCollisionShapeBox>(mat_2,0.11,0.0850000000000001,0.104);
body_2->GetCollisionModel()->AddShape(collshape_2,chrono::ChFramed(chrono::ChVector3d(0.334718818562696,0.394250000000015,0.12045), mr));
...
body_3->SetName("Base_UR5_STEP-1");
body_3->SetPos(chrono::ChVector3d(-0.914818230514467,0.779642372501616,0.840265586893949));
body_3->SetRot(chrono::ChQuaternion<>(0.780732896646653,-1.77675850862547e-18,0.624864900673519,-2.13693318283948e-17));
body_3->SetMass(3.22413490953495);
body_3->SetInertiaXX(chrono::ChVector3d(0.00920548772785535,0.0230003210560511,0.0190350440589591));
body_3->SetInertiaXY(chrono::ChVector3d(0.00115869838989485,0.00232431499043948,-0.000259684885646951));
body_3->SetFrameCOMToRef(chrono::ChFramed(chrono::ChVector3d(3.39195718030347e-06,0.0499745884667967,-0.0091014603553336),chrono::ChQuaternion<>(1,0,0,0)));
...
collshape_3 = chrono_types::make_shared<chrono::ChCollisionShapeBox>(mat_3,0.16,0.16,0.096);
body_3->GetCollisionModel()->AddShape(collshape_3,chrono::ChFramed(chrono::ChVector3d(-6.93889390390723E-18,0.048,2.77555756156289E-17), mr));
...
body_4->SetName("baseUR5e-1");
body_4->SetPos(chrono::ChVector3d(-0.914818230514467,0.757142372501616,0.840265586893949));
body_4->SetRot(chrono::ChQuaternion<>(0.993907734105968,-3.12755571846569e-18,-0.11021531692256,-7.32824405996053e-18));
body_4->SetMass(0.390700550874966);
body_4->SetInertiaXX(chrono::ChVector3d(0.00114309022827863,0.0022590006317847,0.0011443877363986));
body_4->SetInertiaXY(chrono::ChVector3d(-1.86758947993236e-08,3.06815804307673e-07,-8.31729306897553e-08));
body_4->SetFrameCOMToRef(chrono::ChFramed(chrono::ChVector3d(1.1900585456382e-17,0.00883215517656131,1.04958112140661e-05),chrono::ChQuaternion<>(1,0,0,0)));
...
body_5->SetName("Link1_UR5_STEP-1");
body_5->SetPos(chrono::ChVector3d(-0.914818230514467,0.779642372501616,0.840265586893948));
body_5->SetRot(chrono::ChQuaternion<>(0.77017413197471,-3.15988824154224e-17,0.637833682425914,-1.31464436092246e-16));
body_5->SetMass(4.94428012662587);
body_5->SetInertiaXX(chrono::ChVector3d(0.0250041481465757,0.0109158603581209,0.0255680330460476));
body_5->SetInertiaXY(chrono::ChVector3d(0.000600282536190405,0.000110894050527914,-0.000113846742614755));
body_5->SetFrameCOMToRef(chrono::ChFramed(chrono::ChVector3d(-6.78024274082606e-08,0.133183875072103,0.00354771921911234),chrono::ChQuaternion<>(1,0,0,0)));
...
chrono::ChVector3d p1_body_5(0,0.238,0);
chrono::ChVector3d p2_body_5(0,0,0);
body_5->GetCollisionModel()->AddCylinder(mat_5,0.0668003634838783,p1_body_5,p2_body_5);
...
body_6->SetName("Link3_UR5_STEP-1");
body_6->SetPos(chrono::ChVector3d(-0.914273342121355,1.71448489258473,0.872812395774357));
body_6->SetRot(chrono::ChQuaternion<>(0.705218772907502,0.0806743126378385,-0.051637993172058,-0.702489612222424));
body_6->SetMass(8.0823572239203);
body_6->SetInertiaXX(chrono::ChVector3d(0.165825680632585,0.0163631628531026,0.161394315280807));
body_6->SetInertiaXY(chrono::ChVector3d(0.00588849808571756,-0.00116396557008398,0.0286090881038093));
body_6->SetFrameCOMToRef(chrono::ChFramed(chrono::ChVector3d(0.177701166058228,0.00383166697343494,-0.000120751085845636),chrono::ChQuaternion<>(1,0,0,0)));
...
chrono::ChVector3d p1_body_6(-0.0442500000000001,-0.0566999999999987,-0.00159733932179073);
chrono::ChVector3d p2_body_6(-0.0442500000000001,0.0463000000000015,-0.00159733932179034);
body_6->GetCollisionModel()->AddCylinder(mat_6,0.0425,p1_body_6,p2_body_6);
chrono::ChVector3d p3_body_6(-0.00900000000000017,1.47451495458029E-17,-9.18675695743908E-16);
chrono::ChVector3d p4_body_6(0.271,1.47451495458029E-17,-9.18675695743908E-16);
body_6->GetCollisionModel()->AddCylinder(mat_6,0.05,p3_body_6,p4_body_6);
chrono::ChVector3d p5_body_6(0.348,-0.0482,-2.25486296301367E-16);
chrono::ChVector3d p6_body_6(0.348,0.0678000000000002,2.22044604925032E-16);
body_6->GetCollisionModel()->AddCylinder(mat_6,0.065,p5_body_6,p6_body_6);
...
body_7->SetName("Link5_UR5_STEP-1");
body_7->SetPos(chrono::ChVector3d(-0.833897884381497,1.6877363138846,0.369652114857899));
body_7->SetRot(chrono::ChQuaternion<>(0.364234205352301,0.566065007629249,0.307126035364668,0.672738767420354));
body_7->SetMass(1.05804486698019);
body_7->SetInertiaXX(chrono::ChVector3d(0.00121639724910473,0.00107178025478346,0.00129059868936729));
body_7->SetInertiaXY(chrono::ChVector3d(-0.000198974093868049,1.11778662334954e-05,-7.02759593202176e-05));
body_7->SetFrameCOMToRef(chrono::ChFramed(chrono::ChVector3d(0.422595283717868,0.343520074060012,0.129144707206793),chrono::ChQuaternion<>(1,0,0,0)));
...
chrono::ChVector3d p1_body_7(0.425997896121578,0.341550000000018,0.0766);
chrono::ChVector3d p2_body_7(0.425997896121578,0.341550000000018,0.1796);
body_7->GetCollisionModel()->AddCylinder(mat_7,0.04,p1_body_7,p2_body_7);
...
body_8->SetName("start_new-1");
body_8->SetPos(chrono::ChVector3d(-1.15241262841672,0.147142372501616,0.791527490034647));
body_8->SetRot(chrono::ChQuaternion<>(0.702798898660086,-0.702798898660086,-0.0779339979865664,-0.0779339979865664));
body_8->SetMass(777.061473540029);
body_8->SetInertiaXX(chrono::ChVector3d(82.9549016957676,61.1658753618951,109.684183095185));
body_8->SetInertiaXY(chrono::ChVector3d(5.23041424133357,0.512870888573728,-1.4175668823672));
body_8->SetFrameCOMToRef(chrono::ChFramed(chrono::ChVector3d(-0.0015247067577785,-0.00165382711763383,0.111237734465079),chrono::ChQuaternion<>(1,0,0,0)));
body_8->SetFixed(true);
...
mr(0,2)=0; mr(1,2)=-1; mr(2,2)=0;
collshape_8 = chrono_types::make_shared<chrono::ChCollisionShapeBox>(mat_8,0.12078700493303,0.156583617578014,0.393);
body_8->GetCollisionModel()->AddShape(collshape_8,chrono::ChFramed(chrono::ChVector3d(0.00910649753348487,0.0315,0.688291808789007), mr));
mr(0,0)=1; mr(1,0)=0; mr(2,0)=0;
mr(0,1)=1.23389597017419E-16; mr(1,1)=0; mr(2,1)=-1;
mr(0,2)=0; mr(1,2)=1; mr(2,2)=0;
collshape_8 = chrono_types::make_shared<chrono::ChCollisionShapeBox>(mat_8,0.148139846741344,0.168706943007384,0.22);
body_8->GetCollisionModel()->AddShape(collshape_8,chrono::ChFramed(chrono::ChVector3d(0.0574348581100566,-0.303,0.579353471503692), mr));
mr(0,0)=1; mr(1,0)=0; mr(2,0)=1.24881578192201E-16;
mr(0,1)=0; mr(1,1)=0; mr(2,1)=-1;
mr(0,2)=0; mr(1,2)=1; mr(2,2)=0;
collshape_8 = chrono_types::make_shared<chrono::ChCollisionShapeBox>(mat_8,0.889020655165368,0.299196711450916,0.567);
body_8->GetCollisionModel()->AddShape(collshape_8,chrono::ChFramed(chrono::ChVector3d(-0.000702831722705244,0.00600000000000006,-0.200401644274542), mr));
mr(0,0)=1; mr(1,0)=0; mr(2,0)=0;
mr(0,1)=0; mr(1,1)=0; mr(2,1)=-1;
mr(0,2)=0; mr(1,2)=1; mr(2,2)=0;
collshape_8 = chrono_types::make_shared<chrono::ChCollisionShapeBox>(mat_8,0.796680903303464,0.587968632112918,0.463);
body_8->GetCollisionModel()->AddShape(collshape_8,chrono::ChFramed(chrono::ChVector3d(-0.00849427483404774,0.0035,0.293984316056459), mr));
body_8->EnableCollision(true);
//body_8->GetVisualShape(0)->SetOpacity(0.5);
...
body_9->SetName("End_effector_assembly2-1");
body_9->SetPos(chrono::ChVector3d(-0.734404197595021,1.84771345569393,0.893683116829515));
body_9->SetRot(chrono::ChQuaternion<>(0.581610298112794,0.329130187082193,-0.690592010879158,-0.276560039756775));
body_9->SetMass(1.25092539405811);
body_9->SetInertiaXX(chrono::ChVector3d(0.00982600526271352,0.00984171448495844,0.00138395531290137));
body_9->SetInertiaXY(chrono::ChVector3d(-3.98695143803727e-05,-7.92856694741739e-05,0.000101288856527705));
body_9->SetFrameCOMToRef(chrono::ChFramed(chrono::ChVector3d(0.0068723604586369,0.0179620112359557,-0.0971096380965326),chrono::ChQuaternion<>(1,0,0,0)));
...
chrono::ChVector3d p1_body_9(0.00397817890081981,0.0216916002321598,-0.375082667793707);
chrono::ChVector3d p2_body_9(0.00397817890081981,0.0216916002321598,0.00791733220629359);
body_9->GetCollisionModel()->AddCylinder(mat_9,0.0413537027713731,p1_body_9,p2_body_9);
...
body_10->GetVisualShape(0)->SetOpacity(0.5);
...
//   Entity 0: C::E name: body_4 , SW name: baseUR5e-1 ,  SW ref.type:2 (2)
//   Entity 1: C::E name: body_3 , SW name: Base_UR5_STEP-1 ,  SW ref.type:2 (2)
...
//   Entity 0: C::E name: body_4 , SW name: baseUR5e-1 ,  SW ref.type:1 (1)
//   Entity 1: C::E name: body_3 , SW name: Base_UR5_STEP-1 ,  SW ref.type:1 (1)
link = chrono_types::make_shared<chrono::ChLinkMateParallel>();
...
//   Entity 0: C::E name: body_3 , SW name: Base_UR5_STEP-1 ,  SW ref.type:2 (2)
//   Entity 1: C::E name: body_5 , SW name: Link1_UR5_STEP-1 ,  SW ref.type:2 (2)
link = chrono_types::make_shared<chrono::ChLinkMateDistanceZ>();
...
std::dynamic_pointer_cast<chrono::ChLinkMateDistanceZ>(link)->Initialize(body_3,body_5,false,cA,cB,dB);
std::dynamic_pointer_cast<chrono::ChLinkMateDistanceZ>(link)->SetDistance(0);
...
dB = chrono::ChVector3d(-1.6217102793256e-16,-1,2.16382029215825e-16);
std::dynamic_pointer_cast<chrono::ChLinkMateParallel>(link)->SetFlipped(true);
std::dynamic_pointer_cast<chrono::ChLinkMateParallel>(link)->Initialize(body_3,body_5,false,cA,cB,dA,dB);
...
//   Entity 0: C::E name: body_3 , SW name: Base_UR5_STEP-1 ,  SW ref.type:1 (1)
//   Entity 1: C::E name: body_5 , SW name: Link1_UR5_STEP-1 ,  SW ref.type:1 (1)
link = chrono_types::make_shared<chrono::ChLinkMateParallel>();
cA = chrono::ChVector3d(-0.914818230514467,0.878742372501616,0.840265586893949);
...
dA = chrono::ChVector3d(-2.20913348105412e-16,-1,1.80188802434537e-16);
dB = chrono::ChVector3d(-1.62191352842636e-16,-1,2.16378174432865e-16);
std::dynamic_pointer_cast<chrono::ChLinkMateGeneric>(link)->Initialize(body_3,body_5,false,cA,cB,dA,dB);
...
//   Entity 0: C::E name: body_5 , SW name: Link1_UR5_STEP-1 ,  SW ref.type:2 (2)
//   Entity 1: C::E name: body_1 , SW name: Link2_UR5_STEP-1 ,  SW ref.type:2 (2)
link = chrono_types::make_shared<chrono::ChLinkMateDistanceZ>();
...
//   Entity 0: C::E name: body_5 , SW name: Link1_UR5_STEP-1 ,  SW ref.type:1 (1)
//   Entity 1: C::E name: body_1 , SW name: Link2_UR5_STEP-1 ,  SW ref.type:1 (1)
link = chrono_types::make_shared<chrono::ChLinkMateParallel>();
cA = chrono::ChVector3d(-0.841721271711723,0.942142372501616,0.854129014096122);
...
//   Entity 0: C::E name: body_1 , SW name: Link2_UR5_STEP-1 ,  SW ref.type:2 (2)
//   Entity 1: C::E name: body_6 , SW name: Link3_UR5_STEP-1 ,  SW ref.type:2 (2)
link = chrono_types::make_shared<chrono::ChLinkMateDistanceZ>();
...
//   Entity 0: C::E name: body_1 , SW name: Link2_UR5_STEP-1 ,  SW ref.type:1 (1)
//   Entity 1: C::E name: body_6 , SW name: Link3_UR5_STEP-1 ,  SW ref.type:1 (1)
link = chrono_types::make_shared<chrono::ChLinkMateParallel>();
...
//   Entity 0: C::E name: body_6 , SW name: Link3_UR5_STEP-1 ,  SW ref.type:2 (2)
//   Entity 1: C::E name: body_2 , SW name: Link4_UR5_STEP_1000515-1 ,  SW ref.type:2 (2)
link = chrono_types::make_shared<chrono::ChLinkMateDistanceZ>();
...
std::dynamic_pointer_cast<chrono::ChLinkMateDistanceZ>(link)->Initialize(body_6,body_2,false,cA,cB,dB);
std::dynamic_pointer_cast<chrono::ChLinkMateDistanceZ>(link)->SetDistance(0);
...
dB = chrono::ChVector3d(-0.982486005413223,1.11985071820083e-16,-0.186336387125995);
std::dynamic_pointer_cast<chrono::ChLinkMateParallel>(link)->SetFlipped(true);
std::dynamic_pointer_cast<chrono::ChLinkMateParallel>(link)->Initialize(body_6,body_2,false,cA,cB,dA,dB);
...
//   Entity 0: C::E name: body_6 , SW name: Link3_UR5_STEP-1 ,  SW ref.type:1 (1)
//   Entity 1: C::E name: body_2 , SW name: Link4_UR5_STEP_1000515-1 ,  SW ref.type:1 (1)
link = chrono_types::make_shared<chrono::ChLinkMateParallel>();
cA = chrono::ChVector3d(-0.869124244891419,1.75869725547438,0.883232495919559);
...
dA = chrono::ChVector3d(0.982486005413223,-1.95134253625823e-17,0.186336387125996);
dB = chrono::ChVector3d(0.982486005413223,-3.24883474273901e-17,0.186336387125995);
std::dynamic_pointer_cast<chrono::ChLinkMateGeneric>(link)->Initialize(body_6,body_2,false,cA,cB,dA,dB);
...
//   Entity 0: C::E name: body_2 , SW name: Link4_UR5_STEP_1000515-1 ,  SW ref.type:2 (2)
//   Entity 1: C::E name: body_7 , SW name: Link5_UR5_STEP-1 ,  SW ref.type:2 (2)
link = chrono_types::make_shared<chrono::ChLinkMateDistanceZ>();
...
std::dynamic_pointer_cast<chrono::ChLinkMateDistanceZ>(link)->Initialize(body_2,body_7,false,cA,cB,dB);
std::dynamic_pointer_cast<chrono::ChLinkMateDistanceZ>(link)->SetDistance(0);
...
dB = chrono::ChVector3d(0.0100586838281186,-0.998541945674989,-0.0530358898035343);
std::dynamic_pointer_cast<chrono::ChLinkMateParallel>(link)->SetFlipped(true);
std::dynamic_pointer_cast<chrono::ChLinkMateParallel>(link)->Initialize(body_2,body_7,false,cA,cB,dA,dB);
...
//   Entity 0: C::E name: body_2 , SW name: Link4_UR5_STEP_1000515-1 ,  SW ref.type:1 (1)
//   Entity 1: C::E name: body_7 , SW name: Link5_UR5_STEP-1 ,  SW ref.type:1 (1)
link = chrono_types::make_shared<chrono::ChLinkMateParallel>();
cA = chrono::ChVector3d(-0.790598087117437,1.80492974755913,0.900669503142392);
dA = chrono::ChVector3d(-0.0100586838281184,0.998541945674989,0.0530358898035336);
...
dA = chrono::ChVector3d(-0.0100586838281184,0.998541945674989,0.0530358898035336);
dB = chrono::ChVector3d(-0.0100586838281184,0.998541945674989,0.0530358898035335);
std::dynamic_pointer_cast<chrono::ChLinkMateGeneric>(link)->Initialize(body_2,body_7,false,cA,cB,dA,dB);
...
//   Entity 0: C::E name: body_7 , SW name: Link5_UR5_STEP-1 ,  SW ref.type:2 (2)
//   Entity 1: C::E name: body_9 , SW name: End_effector_assembly2-1 ,  SW ref.type:2 (2)
link = chrono_types::make_shared<chrono::ChLinkMateDistanceZ>();
...
std::dynamic_pointer_cast<chrono::ChLinkMateDistanceZ>(link)->Initialize(body_7,body_9,false,cA,cB,dB);
std::dynamic_pointer_cast<chrono::ChLinkMateDistanceZ>(link)->SetDistance(0);
...
dB = chrono::ChVector3d(-0.985359365892694,-0.000870704484685728,-0.170488011077757);
std::dynamic_pointer_cast<chrono::ChLinkMateParallel>(link)->SetFlipped(true);
std::dynamic_pointer_cast<chrono::ChLinkMateParallel>(link)->Initialize(body_7,body_9,false,cA,cB,dA,dB);
...
//   Entity 0: C::E name: body_7 , SW name: Link5_UR5_STEP-1 ,  SW ref.type:1 (1)
//   Entity 1: C::E name: body_9 , SW name: End_effector_assembly2-1 ,  SW ref.type:1 (1)
link = chrono_types::make_shared<chrono::ChLinkMateParallel>();
cA = chrono::ChVector3d(-0.745513082193027,1.85829220107582,0.911395214570801);
dA = chrono::ChVector3d(0.985359365892694,0.000870704484685769,0.170488011077757);
cB = chrono::ChVector3d(-0.745513082193027,1.85829220107582,0.911395214570801);
...
dA = chrono::ChVector3d(0.985359365892694,0.000870704484685769,0.170488011077757);
dB = chrono::ChVector3d(-0.985359365892694,-0.000870704484685793,-0.170488011077757);
std::dynamic_pointer_cast<chrono::ChLinkMateGeneric>(link)->Initialize(body_7,body_9,false,cA,cB,dA,dB);
...
//   Entity 0: C::E name: body_4 , SW name: baseUR5e-1 ,  SW ref.type:2 (2)
//   Entity 1: C::E name: body_8 , SW name: start_new-1 ,  SW ref.type:2 (2)
link = chrono_types::make_shared<chrono::ChLinkMateDistanceZ>();
...
std::dynamic_pointer_cast<chrono::ChLinkMateDistanceZ>(link)->Initialize(body_4,body_8,false,cA,cB,dB);
std::dynamic_pointer_cast<chrono::ChLinkMateDistanceZ>(link)->SetDistance(0);
...
//   Entity 0: C::E name: body_4 , SW name: baseUR5e-1 ,  SW ref.type:2 (2)
//   Entity 1: C::E name: body_8 , SW name: start_new-1 ,  SW ref.type:1 (1)

// Mate constraint: Coincidente18 [MateCoincident] type:0 align:0 flip:False
//   Entity 0: C::E name: body_8 , SW name: start_new-1 ,  SW ref.type:2 (2)
...
std::dynamic_pointer_cast<chrono::ChLinkMateDistanceZ>(link)->Initialize(body_8,body_10,false,cA,cB,dB);
std::dynamic_pointer_cast<chrono::ChLinkMateDistanceZ>(link)->SetDistance(0);
...
cB = chrono::ChVector3d(-0.0101433723263411,-0.202857627498384,1.10182323056413);
dB = chrono::ChVector3d(8.66614664847819e-18,-1,-1.77699551983796e-17);
std::dynamic_pointer_cast<chrono::ChLinkMateParallel>(link)->Initialize(body_8,body_10,false,cA,cB,dA,dB);
...
std::dynamic_pointer_cast<chrono::ChLinkMateDistanceZ>(link)->Initialize(body_10,body_8,false,cA,cB,dB);
...
cB = chrono::ChVector3d(-1.63520195353175,-0.202857627498384,0.967530238748913);
dB = chrono::ChVector3d(-0.219087711812545,1.54074395550979e-33,0.975705167831319);
std::dynamic_pointer_cast<chrono::ChLinkMateParallel>(link)->Initialize(body_10,body_8,false,cA,cB,dA,dB);
