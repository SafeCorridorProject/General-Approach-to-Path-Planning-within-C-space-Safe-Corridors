...
#ifndef CH_ROBOT_FREE_H
#define CH_ROBOT_FREE_H
...
public:
    ...
    std::vector<std::shared_ptr<ChLinkMateRevolute>> GetMotorlist() { return m_motorlist; }
...
protected:
    ...
    std::vector<std::shared_ptr<ChLinkMateRevolute>> m_motorlist;          ///< list of robot motors
