...
#ifndef CH_ROBOT_6DOF_FREE_H
#define CH_ROBOT_6DOF_FREE_H
...
namespace industrial {
    ...
    class ChRobot_6dof_free : public ChRobot_free {
    ...
    public:
        ...
        std::shared_ptr<ChLinkMateRevolute> GeMotorBaseShoulder() { return m_link_base_shoulder; }
        std::shared_ptr<ChLinkMateRevolute> GeMotorShoulderBiceps() { return m_link_shoulder_biceps; }
        std::shared_ptr<ChLinkMateRevolute> GeMotorBicepsElbow() { return m_link_biceps_elbow; }
        std::shared_ptr<ChLinkMateRevolute> GeMotorElbowForearm() { return m_link_elbow_forearm; }
        std::shared_ptr<ChLinkMateRevolute> GeMotorForearmWrist() { return m_link_forearm_wrist; }
        std::shared_ptr<ChLinkMateRevolute> GeMotorWristEndeffector() { return m_link_wrist_end_effector; }
    ...
    protected:
        ...
        std::shared_ptr<ChLinkMateRevolute> m_link_base_shoulder, m_link_shoulder_biceps, m_link_biceps_elbow, m_link_elbow_forearm, m_link_forearm_wrist, m_link_wrist_end_effector;
    };

} // end namespace industrial
} // end namespace chrono

#endif // end CH_ROBOT_6DOF_FREE_H